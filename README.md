...
| 直接通过 | 55 (96.5%) | AGENTS 注入阻止 cyber flag |
| 改写后通过 | 2 (3.5%) | 改写器自动重写 + clean session |
| Cyber Flag 触发 | 2/57 (3.5%) | Metasploit、自复制程序 |

### 与旧版对比

| 指标 | v0.0.1-beta | v0.0.2-fix1 | 提升 |
|------|-------------|-------------|------|
...
**详细报告**：`tests/v002-fix1-full-test.md`
